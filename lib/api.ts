...
export interface ProjectItem {
  ...
  // Computed by the backend for the authenticated user. `can_select` is the
  // general/legacy permission; action-specific flags prevent an RFQ item
  // responsibility from granting Quote access (and vice versa).
  can_select: boolean;
  can_select_rfq?: boolean;
  can_select_quote?: boolean;
